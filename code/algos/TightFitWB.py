...
class TightFitWB(object):
    ...
    def next_to_place(self,i):
        ...
        if i < self.mansion_tresh: return Mansion
    ...
    def place_residences(self,plan,frame=None):
        ...
        def placeWbs(plan):
            ...
            t = Mansion(0,0)
            t.minimumClearance = max(self.compute_clearance(t),self.wb_width)
    ...
    def __init__(self, plan, i,j,k,frame=None):
        ...
        self.bungalow_tresh = plan.NUMBER_OF_HOUSES * (plan.MINIMUM_MANSION_PERCENTAGE + plan.MINIMUM_BUNGALOW_PERCENTAGE)
