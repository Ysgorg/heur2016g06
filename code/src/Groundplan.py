...
class Groundplan(object):
    ...
    def getNumberOfHouses(self): return self.num_houses
    ...
    def numberOfHouses(self): return self.num_houses
    ...
    def addResidence(self, residence):
        t = residence.getType()
        if t == "FamilyHome":   self.number_of_familyhomes += 1
        elif t == "Bungalow":   self.number_of_bungalows += 1
        elif t == "Mansion":    self.number_of_mansions += 1
        self.num_houses += 1
    ...
    def correctlyPlaced(self, o):
        ...
        for r in self.residences:
            if r is not o and (self.overlap(r, o) or (not isinstance(o,Waterbody) and self.getDistance(r, o) < max(self_clearance, r.minimumClearance))):
                return False
