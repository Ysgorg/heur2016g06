...
First, across all:
 ...
 - TODO integrate with auto plot generation
...
![](manual_images/randomness.png)

 - spread in plan value across several runs, on same settings
...
### Usefulness of work
 ...
 - Every of the heuristics that we implemented improved our solution score/finding time.
 - Visualizing rectangle reach perimeter aids human intuition in plan evaluation.
 - Future algorithms can be added to the batch test framework.
 - Modular design lets us easily add more algorithms, more data analysis, more plots.
